...
def BuildModel(request):
    global classifier
    train = pd.read_csv('C:/Python/ITSFeedback/dataset/affect_estimates.csv')
...
def AffectState(request):
    ...
    if request.method == 'POST':
      ...
      file = open('C:/Python/ITSFeedback/dataset/temp1.txt','w')
      file.write(strdata)
      file.close()    
      test = pd.read_csv('C:/Python/ITSFeedback/dataset/temp1.txt')
